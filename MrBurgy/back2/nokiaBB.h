...
#define		nokia_RST_pin		PINC5
#define		nokia_CE_pin		PINC4//when low -> command
#define		nokia_DC_pin		PINC3
...
// 	BB_send(0b00001100);	//sets display configuration D=1 E=0;
	...
	BB_send(0x06);	// temperature correction
	BB_send(0x13);	// 1:48
